...
-- UnitOfMeasure Table (Composition with Product)
...
-- PromotionCondition Table (Composition with Promotion)
...
-- PromotionAction Table (Composition with Promotion)
...
-- InvoiceLine Table (Composition with Invoice)
