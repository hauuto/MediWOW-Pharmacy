...
public class AppColors {
    public static final Color PRIMARY = Color.decode("#049DD9");
    public static final Color SECONDARY = Color.decode("#05C7F2");
    public static final Color DARK = Color.decode("#03738C");
    public static final Color LIGHT = Color.decode("#71C6D9");
